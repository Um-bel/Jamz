...
//will only work on me fow some reason, if you try to do anyone else it will error, the error is . probaly has something to do with my login... maybe. 